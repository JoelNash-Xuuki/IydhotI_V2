...
;;=================================================================================================================
i 40	[0 + (0.25 * $SMQV.) + (4 * $SMBR.) + (16 * $CNT.)]      0.01	41	100
...
i 40	[2.5 + (0.25 * $SMQV.) + (4 * $SMBR.) + (16 * $LOOP_L.)]	0.01	41	100
 ...
 ; i .	    [12 + 0.05 + (16 * $CNT.)]	.	.	6.00	.	.	.	.	.	.
  ...
  ;i.	[0.5 + (16 * $CNT.)]	3	25	120	35

  ;;TOMS
  ;i .	[1.5 + (16 * $CNT.)]	1	25	80	55

;  $Harmony. [0 + (16 * $CNT.)]	$Bars	30	8.00 1 1 0 . . 0
;  i .	    [2 + (16 * $CNT.)]	.	    20	8.05 . . . . . .
;  i .	    [8 + (16 * $CNT.)]  8	    17	8.07 . . . . . .
;  i .	    [10 + (16 * $CNT.)]	.	    .	8.09 . . . . . .
  ...
  ;{ 16 SMBR
  ;  $Rim.	[1 + (4 * $SMBR.) + (16 * $CNT.)]	0.01	56    80
  ;  $Rim. 	[3 + (4 * $SMBR.) + (16 * $CNT.)]	0.02	56    25
  ;}
