...
;i.	     [15 + (16 * $TWOBARS.)]		4	25	120	34
  ...
  { 4 LOOP_L
	 i 50	[0  + (16 * $TWOBARS.)]	.22		52	60
     i 52	[0.5  + (16 * $TWOBARS.)]	0.001	56	60
  	 i 50	[2  + (16 * $TWOBARS.)]	.22		52	60
	 ;i 52	[3  + (16 * $TWOBARS.)]	0.005	56	30
	 i 52	[6  + (16 * $TWOBARS.)]	0.001	56	60
